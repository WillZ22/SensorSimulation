...
public class InsertInsuteObservationThread extends Thread{
	...
	public InsertInsuteObservationThread(String sensorname ,String sosurl, String unit, String propertyname) {
	...
	public void run() {
		...
		try {
			String sml = encoder.encodeInsertSensorReq(offerings.get(0), procedure, propertyname, "Test", "test", propertyname, unit);
        ...
        while(status == 1) {
    		...
    		String observableProperty = "urn:swt:def:observableProperty:"+propertyname;
    		Double pressue = createData.randomValue();
