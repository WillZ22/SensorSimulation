...
public class InsertMoveObservationThread extends Thread{
	...
	public InsertMoveObservationThread(String sensorname ,String sosurl, String unit, String propertyname) {
